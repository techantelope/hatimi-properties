...
class CashfreeModel extends Model
{
    function __construct(){
        ...
        $this->app_id = '2828476e94c9904de1e09cae10748282'; //Sandbox
        $this->secret = '69301ab864304e47cdd1a3004b7ccad5d1168d41'; //Sandbox

        $this->auth = base64_encode($this->key.":".$this->secret);
        $this->endpoint = 'https://sandbox.cashfree.com/pg';
    }
